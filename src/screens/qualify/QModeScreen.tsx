...
interface QModeScreenProps {
  onSelect: (mode: GameMode, timeLimit?: number) => void
  onBack: () => void
}

export default function QModeScreen({ onSelect, onBack }: QModeScreenProps) {
  return (
      ...
      <div className="space-y-4">
        <Panel>
          ...
          <div className="space-y-2">
            <GoldBtn fullWidth onClick={() => onSelect('time', 30)}>
              30秒
            </GoldBtn>
            <GoldBtn fullWidth onClick={() => onSelect('time', 60)}>
              60秒
            </GoldBtn>
            <GoldBtn fullWidth onClick={() => onSelect('time', 90)}>
              90秒
            </GoldBtn>
          </div>
        </Panel>
